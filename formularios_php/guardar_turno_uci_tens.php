...
$stmt = $mysqli->prepare("INSERT INTO formulario_turnos_uci_tens (
    fecha, tipoturno, medico_turno, 
...
if ($stmt->execute()) {
    ...
    if ($id_formulario > 0) {
        ...
        header("Location: generar_pdf_uci_tens.php?id=" . $id_formulario);
        exit();
    } else {
