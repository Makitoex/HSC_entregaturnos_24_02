...
$sql = "SELECT id_funcionarios, id_profesion, nombre_funcionarios, rut_funcionarios, pin_funcionarios FROM funcionarios_uti WHERE id_servicio = 2 ORDER BY id_funcionarios";
...
<head>
    ...
    <title>Entrega de Turno TENS UTI</title>
    ...
    <div class="container mt-4">
        ...
        <form action="guardar_turno_tens.php" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <label for="controlmedico">Control por médico residente:</label>
                    <select id="turno" name="control_medico_residente" class="form-select form-select-sm" required>
                        <option value="control_si">Sí, todos los pacientes controlados</option>
                        <option value="control_si_pero">Sí, pero faltaron pacientes</option>
                        <option value="control_no">No se realiza control médico</option>
                    </select>
                </div>
            </div>
            <br>
